...
export class Building {
    constructor(scene, x, y, h, size) {
        ...
        this.floor = new SideViewGraphics(scene);

        // 수직선
        this.side1 = new SideViewGraphics(scene);
        this.side2 = new SideViewGraphics(scene);
        this.side3 = new SideViewGraphics(scene);
        this.side4 = new SideViewGraphics(scene);

        this.loop = new SideViewGraphics(scene); // loop
